...
ADMINS = [("""Antoine Gibek""", "antoine.gibek@ipsl.fr")]
...
GRAFANA_ALERTS_FOLDER = "CCRES Alerts"
INFLUX_DB_DATASOURCE_NAME = "InfluxDB"
INFLUX_DB_BUCKET = "mybucket"
